...
<div class="wrapper">
	...
	-->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a  class="simple-text">
                    SISTEMA ADMINISTRATIVO VETERINARIO
                </a>
            </div>
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="Registro_Usuario_Sistema.php">
                        <i class="ti-user"></i>
                        <p>Perfil de Usuario</p>
                    </a>
                </li>
                <li class="active">
                    <a href="Busqueda_Informacion.php">
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Busqueda de Información</a>
